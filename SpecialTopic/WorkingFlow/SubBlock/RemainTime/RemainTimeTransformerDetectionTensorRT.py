...
import time
from SpecialTopic.Deploy.RemainEatingTime.RemainEatingTimeObject import RemainEatingTimeTensorrt
from SpecialTopic.ST.utils import get_cls_from_dict


class RemainTimeTransformerDetectionTensorRT:
    def __init__(self, model_cfg, time_gap, min_remain_detection, reduce_mode_buffer, reduce_mode_output, keep_time):
        ...
        self.model = RemainEatingTimeTensorrt(**model_cfg)
    ...
    def update_output_data(self, track_id):
        ...
        predict_sequence = self.model(food_remain=food_remain)
        idx = len(food_remain)
...
def test():
    ...
    import time
    model_cfg = {
        'encoder_trt_path': r'C:\DeepLearning\SpecialTopic\Deploy\RemainEatingTime\RemainEatingTimeEncoder.trt',
        'decoder_trt_path': r'C:\DeepLearning\SpecialTopic\Deploy\RemainEatingTime\RemainEatingTimeDecoder.trt',
    ...
    remain_time_detection = RemainTimeTransformerDetectionTensorRT(**TransformerNlp_cfg)
