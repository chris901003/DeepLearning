...
def parse_args():
    ...
    # 訓練權重路徑
    parser.add_argument('--pretrained', type=str, default='/Users/huanghongyan/Downloads/segformer_mit-b0_512x512_'
                                                          '160k_ade20k_20220617_162207-c00b9603.pth')
