...
def parse_args():
    ...
    # 分類類別文件
    parser.add_argument('--classes-path', type=str, default=r'C:\Dataset\SegmentationFoodRemain\seg_\classes.txt')
    ...
    # 要使用哪個CLASSES與PLATTE
    parser.add_argument('--data-name', type=str, default='FoodAndNotFood')
    ...
    # 給保存的權重命名，比較好分類
    parser.add_argument('--weight-name', type=str, default='221121_DonburiRice_FoodAndNotFood_eval')
