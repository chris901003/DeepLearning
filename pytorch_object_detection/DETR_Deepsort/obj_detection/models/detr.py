...
"""
DETR models and criterion classes.
"""
import torch
import torch.nn.functional as F
from torch import nn

from obj_detection.util import box_ops
from obj_detection.util.misc import (NestedTensor, nested_tensor_from_tensor_list,
...
class PostProcess(nn.Module):
    """ This module converts the models's output into the format expected by the coco apis"""
    @torch.no_grad()
