...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, attn_mask):
        ...
        if self.shift_size > 0:
            ...
            shifted_x = x
            attn_mask = None
        x_windows = window_partition(shifted_x, window_size=self.window_size)
...
class SwinTransformer(nn.Module):
    def __init__(self, patch_size=4, in_chans=3, num_classes=1000, embed_dim=96, depths=(2, 2, 6, 2),
